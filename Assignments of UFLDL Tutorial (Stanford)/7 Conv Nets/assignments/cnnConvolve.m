function convolvedFeatures = cnnConvolve(patchDim, numFeatures, images, W, b, ZCAWhite, meanPatch)
    ...
    %  ZCAWhite, meanPatch - ZCAWhitening and meanPatch matrices used for preprocessing
    %
    % Returns:
    ...
    for imageNum = 1:numImages
        for featureNum = 1:numFeatures
            ...
            for channel = 1:imageChannels
                ...
                % ---- YOUR CODE HERE ----
                feature = W(featureNum, patchDim*patchDim*(channel-1)+1 : patchDim*patchDim*channel); % You should replace this
