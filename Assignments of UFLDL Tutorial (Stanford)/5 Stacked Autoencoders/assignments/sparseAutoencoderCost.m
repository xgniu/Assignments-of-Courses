function [cost,grad] = sparseAutoencoderCost(theta, visibleSize, hiddenSize, lambda, sparsityParam, beta, data)
    ...
    delta3 = (h3-data) .* sigmoid_prime(z3);
    delta2 = ( W2' * delta3 + repmat(sparsity_grad,1,m) ) .* sigmoid_prime(z2);
    ...
    %         a3 = sigmoid(z3);
    %
    %         cost = cost + norm(a3-xi)^2 / m / 2;
    %
    %         delta3 = (a3-xi) .* sigmoid_prime(z3);
    %         delta2 = ( W2' * delta3 + sparsity_grad ) .* sigmoid_prime(z2);
    %
