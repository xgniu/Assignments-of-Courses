...
% need a function pointer with two outputs: the function value and the gradient. In our problem,
...
lambda = 1e-4;
options.maxIter = 100;
inputSize = size(sae2Features,1);
softmaxModel = softmaxTrain(inputSize, numClasses, lambda, sae2Features, trainLabels, options);
